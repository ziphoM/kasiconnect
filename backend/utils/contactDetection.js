...
const saPhonePatterns = [
  /(0[0-9]{9})\b/,                    // 0821234567 (10 digits with leading 0)
  /(0[0-9]{2}[-\s]?[0-9]{3}[-\s]?[0-9]{4})\b/, // 082-123-4567 or 082 123 4567
  /(\+27[0-9]{9})\b/,                  // +27821234567
  /(27[0-9]{9})\b/,                    // 27821234567
  /(0[0-9]{2}\.[0-9]{3}\.[0-9]{4})\b/, // 082.123.4567
  /(0[0-9]{2}\s[0-9]{3}\s[0-9]{4})\b/, // 082 123 4567
  /(0[0-9]{9})/,                       // 0821234567 (anywhere in text)
  /(0[0-9]{2}[-.\s]?[0-9]{3}[-.\s]?[0-9]{4})/ // More flexible pattern
];
